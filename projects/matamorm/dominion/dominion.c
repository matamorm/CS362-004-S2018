...
int adventurerCardEffect(int currentPlayer, struct gameState *state, int temphand[]){
      int drawntreasure = 0;
      int cardDrawn;
      int z = 0;      

      //BUG: Allows the the drawing of 3 Treasure cards, as opposed to 2 Treasure cards
...
int smithyCardEffect(int currentPlayer, struct gameState *state, int handPos){
      int i;
  	//+3 Cards
	//BUG: Allows the drawing of 2 cards, as opposed to 3 cards
      for (i = 0; i < 2; i++)
	{
	  drawCard(currentPlayer, state);
	}
...
int villageCardEffect(int currentPlayer, struct gameState *state, int handPos){
      ...
      //+2 Actions
      //BUG: Grants only 1 extra Action, as opposed to 2 actions
...
int great_hallCardEffect(int currentPlayer, struct gameState *state, int handPos){
      //+1 Card
      drawCard(currentPlayer, state);
			
      //+1 Actions
      //BUG: Does not grant an extra Action during player turn
      //state->numActions++;
...
int embargoCardEffect(int currentPlayer, struct gameState *state, int handPos, int choice1){
      //+2 Coins
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCardEffect(currentPlayer, state, temphand);
    ...
    case great_hall:
      return great_hallCardEffect(currentPlayer, state, handPos);
    ...
    case embargo: 
      return embargoCardEffect(currentPlayer, state, handPos, choice1);	
